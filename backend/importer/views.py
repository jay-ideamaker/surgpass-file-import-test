...
#         """
#         A callback function for mammoth to handle each image it finds.
#         It uploads the image to Supabase and returns the public URL.
#         """
...
#     # Convert the entire doc to HTML with images uploaded to Supabase
#     docx_file.seek(0)
#     html_result = mammoth.convert_to_html(docx_file, convert_image=images.img_element(convert_image))
#     full_html = html_result.value

#     # Split the document into individual question blocks based on our tag
#     question_html_blocks = full_html.split("<p>[QUESTION_START]</p>")[1:]
    
#     created_question_ids = []
#     for block_html in question_html_blocks:
#         soup = BeautifulSoup(block_html, 'html.parser')

#         # --- 1. Create the main Question object ---
...
#         # --- 3. Handle Answer Choices (One-to-Many) ---
...
#                 if text: # Only create if there's answer text
...
#         # --- 5. Handle QuickHits (Nested One-to-Many) ---
...
#                 if qh_question_text:
#                     quick_hit = QuickHit.objects.create(
#                         parent_question=question,
#                         question_text=qh_question_text,
#                         rationale=qh_rationale_text
#                     )
